...
pr1.respuestaRobot(id, "Hola, en qué puedo ayudarte")
#print("Escuchando...")
...
while True:
   ...
   ## print("🎤 Texto reconocido:", user_message)
    ...
    if any(keyword in user_message.lower() for keyword in ["terminar", "adiós", "cancelar"]):
        pr1.respuestaRobot(id, "Claro, adiós. ¡Que tengas un excelente día!")
        break
    ...
    if user_message:
        ...
        try:
            ...
            pr1.respuestaRobot(id, respuesta.content)
            print("LRS2 responde:", respuesta.content)
        except Exception as e:
            print(f"Ocurrió un error con LRS2: {e}")
            pr1.respuestaRobot(id, "¿Podrías repetirlo?")
